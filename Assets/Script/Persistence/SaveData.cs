...
namespace Game.Persistence
{
    ...
    /// <summary>
    /// v5 schema. Two anchors: <see cref="checkpoint"/> (death-respawn, set by save points) and
    ...
    public class SaveData
    {
        ...
        /// <summary>Permanent player-progression unlocks (e.g. "glide"). Added in v5.</summary>
        public List<string> abilitiesUnlocked = new List<string>();
    }
}
